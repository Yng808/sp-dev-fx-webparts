define([], function () {
    return {
        ...
        RefinerPanel: {
            ...
            Field_EditableByAdminsOnly: { Label: "Editable by admins only", OnText: "Yes", OffText: "No", Tooltip: "Only admins can change this refiner on the event edit form. Non-admins can still see the selected value in display views." },
            Field_DefaultValue: { Label: "Default value", Tooltip: "The value that will be selected automatically when creating a new event." },
            DefaultValue_None: "(no default)",
