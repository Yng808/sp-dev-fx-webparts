...
export const ExternalListsSettings: FC<IExternalListsSettingsProps> = ({
  isOpen,
  onDismiss,
  configs,
  onSave,
  ...
  const columns: IColumn[] = [
    {
      ...
      name: 'List',
      minWidth: 200,
      onRender: (i: ExternalListConfig) => i.listTitle || i.listId
    },
    {
      key: 'siteUrl',
      name: 'Site',
      minWidth: 250,
      onRender: (i: ExternalListConfig) => i.siteUrl
    },
    {
      key: 'enabled',
      name: 'Enabled',
      minWidth: 70,
      onRender: (i: ExternalListConfig) => <Checkbox checked={i.enabled} disabled />
    },
    {
      key: 'actions',
      name: '',
      minWidth: 80,
      onRender: (i: ExternalListConfig) => (
  ...
  return (
    <Panel
      ...
      headerText="External Lists Configuration"
    >
